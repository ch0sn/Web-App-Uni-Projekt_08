...
<div class="gridCoursesClass">
    ...
    <div class="BodyCourseClass">
        ...
        <script>
            ...
            function buttonsAdd(parentDiv) {

                parentDiv.appendChild(document.getElementById("textField"));
                parentDiv.appendChild(document.getElementById("studentsFileUpload"));
                parentDiv.appendChild(document.getElementById("fileUpload"));
                parentDiv.appendChild(document.getElementById("dividingLine"));
                parentDiv.appendChild(document.getElementById("deleteButton"));
            }
            ...
            function addTextfield(buttonId) {
                ...
                const isTextareaActive = parentDiv.classList.contains('active-textarea');

                if (isTextareaActive) {
                    // Textfeld entfernen
                    parentDiv.innerHTML = '';
                    buttonsAdd(parentDiv);
                    parentDiv.classList.remove('active-textarea');
                } else {
                    // Textfeld hinzufügen
                    const textarea = createTextarea();
                    parentDiv.appendChild(textarea);
                    parentDiv.classList.add('active-textarea');
                }
            }
            ...
            function createTextarea() {
                ...
                textarea.style.width = bodyCourseClassWidth;
                ...
                textarea.id = 'textArea' + numberOfTextareas;
                numberOfTextareas++;
                return textarea;
            }
            ...
            function arrayToWebsite(array) {
                ...
                for (let i = 0; i < array.length; i++) {
                    ...
                    if (item.id.includes('textArea')) {
                        ...
                        console.log(elementsContainer.innerHTML);
                    }
