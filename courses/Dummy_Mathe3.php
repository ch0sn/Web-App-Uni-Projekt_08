...
?>
    ...
    <div class="gridCoursesClass">
        ...
        <div class="HeaderCourseClass">
            ...
            <h1 id="courseNameHeaderId">Mathe 3</h1>

            <p id= "courseInformation"> Fachbereich 13: MND / Wintersemester / ab 5.Semester / Dr. Hans Maier</p>
        ...
        <div class="BodyCourseClass">
            ...
            <h2> Willkommen zum "Mathe 3" Kurs.</h2>
            <p></p>
