    ...
    <nav>
        ...
        <ul>
            ...
            <div class="searchBar">
                ...
                <input type="search" id="suche" placeholder="Suchfeld"> </input>





                <button id="searchButton" onclick="t()"></button>
            </div>
            ...
            <script>
                document.addEventListener("click", function(event) {
                    ...
                    // Prüfe, ob das Klickereignis nicht auf den Suchbutton oder das Suchergebnis erfolgt ist
                    if (
                ...
                function t() {
                    ...
                    var eingabe = document.getElementById("suche").value;
                    var xhr = new XMLHttpRequest();
                    xhr.open("POST", "../includes/kursseiteEdit.inc.php?method=CoursesSearchBar", true);
                    ...
                    var data = "searchContent=" + eingabe; // Passen Sie hier die Werte entsprechend an
                    xhr.send(data);
